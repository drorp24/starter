...
RSpec.describe ProfessionalProfilesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested professional_profile as @professional_profile" do
      professional_profile = ProfessionalProfile.create! valid_attributes
      get :show, {:id => professional_profile.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested professional_profile as @professional_profile" do
      professional_profile = ProfessionalProfile.create! valid_attributes
      get :edit, {:id => professional_profile.to_param}, valid_session
      expect(assigns(:professional_profile)).to eq(professional_profile)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ProfessionalProfile" do
        expect {
          post :create, {:professional_profile => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved professional_profile as @professional_profile" do
        post :create, {:professional_profile => invalid_attributes}, valid_session
        expect(assigns(:professional_profile)).to be_a_new(ProfessionalProfile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested professional_profile" do
        professional_profile = ProfessionalProfile.create! valid_attributes
        put :update, {:id => professional_profile.to_param, :professional_profile => new_attributes}, valid_session
      ...
      it "assigns the requested professional_profile as @professional_profile" do
        professional_profile = ProfessionalProfile.create! valid_attributes
        put :update, {:id => professional_profile.to_param, :professional_profile => valid_attributes}, valid_session
        expect(assigns(:professional_profile)).to eq(professional_profile)
      end
    ...
    describe "with invalid params" do
      it "assigns the professional_profile as @professional_profile" do
        professional_profile = ProfessionalProfile.create! valid_attributes
        put :update, {:id => professional_profile.to_param, :professional_profile => invalid_attributes}, valid_session
        expect(assigns(:professional_profile)).to eq(professional_profile)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested professional_profile" do
      professional_profile = ProfessionalProfile.create! valid_attributes
      expect {
        delete :destroy, {:id => professional_profile.to_param}, valid_session
      }.to change(ProfessionalProfile, :count).by(-1)
    end
