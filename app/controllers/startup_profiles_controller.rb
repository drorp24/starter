class StartupProfilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @startup_profile.save
        ...
        format.json { render :show, status: :created, location: @startup_profile }
      else
  ...
  def update
    respond_to do |format|
      if @startup_profile.update(startup_profile_params)
        ...
        format.json { render :show, status: :ok, location: @startup_profile }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to startup_profiles_url, notice: 'Startup profile was successfully destroyed.' }
  ...
  private
    ...
    def startup_profile_params
      params.require(:startup_profile).permit(:role)
    end
end
